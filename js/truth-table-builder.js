...
const tableBuilderExamples = {
    'ex1': {
        ...
        rows: [
            { p: 'T', q: 'T', col2: 'F', col3: 'T', col4: 'T' },
            { p: 'T', q: 'F', col2: 'F', col3: 'F', col4: 'T' },
            { p: 'F', q: 'T', col2: 'T', col3: 'T', col4: 'F' },
            { p: 'F', q: 'F', col2: 'T', col3: 'T', col4: 'F' }
        ],
    ...
    'ex2': {
        ...
        rows: [
            { p: 'T', q: 'T', col2: 'T', col3: 'F' },
            { p: 'T', q: 'F', col2: 'F', col3: 'T' },
            { p: 'F', q: 'T', col2: 'F', col3: 'F' },
            { p: 'F', q: 'F', col2: 'F', col3: 'F' }
        ],
        classification: 'Contingency'
    },
    'ex3': {
        ...
        rows: [
            { p: 'T', q: 'T', col2: 'T', col3: 'T', col4: 'T' },
            { p: 'T', q: 'F', col2: 'F', col3: 'T', col4: 'F' },
            { p: 'F', q: 'T', col2: 'T', col3: 'F', col4: 'F' },
            { p: 'F', q: 'F', col2: 'T', col3: 'T', col4: 'T' }
        ],
        classification: 'Contingency'
    },
    'ex4': {
        ...
        rows: [
            { p: 'T', q: 'T', col2: 'T', col3: 'F' },
            { p: 'T', q: 'F', col2: 'F', col3: 'T' },
            { p: 'F', q: 'T', col2: 'F', col3: 'T' },
            { p: 'F', q: 'F', col2: 'F', col3: 'T' }
        ],
        classification: 'Contingency'
    },
    'ex5': {
        title: '(p → q) ∨ (p ∧ ~q) (Tautology)',
        headers: ['p', 'q', 'p → q', '~q', 'p ∧ ~q', '(p → q) ∨ (p ∧ ~q)'],
        rows: [
            { p: 'T', q: 'T', col2: 'T', col3: 'F', col4: 'F', col5: 'T' },
            { p: 'T', q: 'F', col2: 'F', col3: 'T', col4: 'T', col5: 'T' },
            { p: 'F', q: 'T', col2: 'T', col3: 'F', col4: 'F', col5: 'T' },
            { p: 'F', q: 'F', col2: 'T', col3: 'T', col4: 'F', col5: 'T' }
        ],
    ...
    'ex6': {
        ...
        rows: [
            { p: 'T', q: 'T', col2: 'T', col3: 'F', col4: 'F', col5: 'F', col6: 'F' },
            { p: 'T', q: 'F', col2: 'T', col3: 'F', col4: 'T', col5: 'F', col6: 'F' },
            { p: 'F', q: 'T', col2: 'T', col3: 'T', col4: 'F', col5: 'F', col6: 'F' },
            { p: 'F', q: 'F', col2: 'F', col3: 'T', col4: 'T', col5: 'T', col6: 'F' }
        ],
...
document.getElementById('builder-generate-btn').addEventListener('click', function() {
    ...
    example.rows.forEach((row, rowIndex) => {
        ...
        while(row[`col${colIndex}`] !== undefined) {
            const correctValBase = row[`col${colIndex}`];
...
function resetBuilderCellClick() {
